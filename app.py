...
# Upload a DOCX file
uploaded_file = left_column.file_uploader("
        - Upload a document with quotes from various articles on the topic you are researching, including the reference in APA format (max. 2000 words). , type=["docx"])
